...
public static partial class PathUtils {
    ...
    /// ArchivePath
    /// </summary>
    public static string ArchivePath = CombinePath(PersistentDataPath);
    /// <summary>
    /// 用户数据路径
    /// </summary>
    ...
    /// UI路径
    /// </summary>
    public static string UIPrefabPath = CombinePath("Assets", "AssetsData", "Prefabs", "UI");
    /// <summary>
    /// UI路径
    /// </summary>
    public static string ScenePath = CombinePath("Assets", "AssetsData", "Scenes");
    /// <summary>
    /// 资源目录
    /// </summary>
    ...
    public static string GetStreamingAssetsResPath(string name)
    {
        ...
        Debug.Log("GetStreamingAssetsResPath: " + path);

        if (File.Exists(path)){
            return path;
        }
        else {
            Debug.LogError("GetStreamingAssetsResPath Error : " + path);
            return path;
        }
        return "";
    ...
    public static string ResourcePath
    {
        get
        {
            return PathUtils.CombinePath(PathUtils.StreamingAssetsWWWPath, "puzzleGame");
        }
    }
