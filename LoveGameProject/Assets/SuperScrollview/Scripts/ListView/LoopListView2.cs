...
namespace SuperScrollView {
    ...
    public class LoopListView2 : MonoBehaviour, IBeginDragHandler, IEndDragHandler, IDragHandler {
        ...
        public static Action onGlobalLoopViewListBeginDrag;
        ...
        public bool mListViewInited = false;
        ...
        */
        ...
        public void SetMaxSize(int itemCount) {
            SetListItemCount(itemCount);
            UpdateContentSize();
       ...
       */
        ...
        public virtual void OnBeginDrag(PointerEventData eventData) {
            ...
            if(onGlobalLoopViewListBeginDrag != null){
                onGlobalLoopViewListBeginDrag?.Invoke();
            }
        }
        ...
        public void SetItemDefaultSize(float size,int maxCount){
            mItemPosMgr.SetItemDefaultSize(size,maxCount);
        }
        ...
        public void SetCurSnapNearestItemIndex(int index) {
            mCurSnapNearestItemIndex = index;
        }
    }
}
