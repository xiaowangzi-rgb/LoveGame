...
namespace LSave {
    public class LEncryptDatabaseConfig : DatabaseConfig {
        public static void ResetStorage() {
            BoxFileStreamConfig.AdapterType = typeof(LEncryptDatabaseConfig);
        }
        ...
        private class LocalStream : IBStream {
